...
public class main extends AppCompatActivity {
    ...
    final Fragment fragment2 = new search_frag();
    final Fragment fragment3 = new noti_frag();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        go_postactivity=findViewById(R.id.go_postactivity);
        go_postactivity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(main.this, post_activity.class);
                startActivity(i);
            }
        });
